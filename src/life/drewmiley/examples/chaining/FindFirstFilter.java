...
public class FindFirstFilter {
    ...
    public List<SimpleObject> runStreamForList(List<ComplexObject> complexObjects) {
        return null;
    }

    public List<SimpleObject> runImperativeForList(List<ComplexObject> complexObjects) {
        return null;
    }
}
